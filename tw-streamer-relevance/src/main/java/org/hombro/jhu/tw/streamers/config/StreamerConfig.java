...
import org.hombro.jhu.tw.streamers.services.RelevancyService;
...
public class StreamerConfig {
  ...
  @Bean(value = "tasks")
  public List<RelevancyService> services(List<TwitchAPI> apis, MongoTemplate mongoTemplate)
      throws IOException {
    ...
    return zip(apis.stream(), buckets.stream(), (api, bucket) -> new RelevancyService(bucket, api,
        mongoTemplate))
        .collect(Collectors.toList());
  }
}
