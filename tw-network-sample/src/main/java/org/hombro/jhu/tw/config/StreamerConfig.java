...
import org.hombro.jhu.tw.services.TwitchSamplerService;
...
public class StreamerConfig {
  ...
  @Bean(value = "tasks")
  public List<TwitchSamplerService> services(List<TwitchAPI> apis, MongoTemplate mongoTemplate)
      throws IOException {
    ...
    return zip(apis.stream(), buckets.stream(), (api, bucket) -> new TwitchSamplerService(
        bucket, api,
        mongoTemplate))
        .collect(Collectors.toList());
  }
